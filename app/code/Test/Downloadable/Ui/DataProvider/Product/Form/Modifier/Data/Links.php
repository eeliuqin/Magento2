<?php
/**
 * Override Magento_Downloadable to add is_visible to link data
 */

namespace Test\Downloadable\Ui\DataProvider\Product\Form\Modifier\Data;
...
class Links extends \Magento\Downloadable\Ui\DataProvider\Product\Form\Modifier\Data\Links
{
    ...
    public function getLinksData()
    {
        ...
        foreach ($links as $link) {
            ...
            $linkData['is_visible'] = $link->getIsVisible(); //add is_visible
